...
**Objective:** Set expectations and go through introductory topics.
...
## Class 5: Python and Pandas Crash Course (Tue, Jan 26)
...
**Instructor Prep:** Review all submitted proposals beforehand to anticipate where students will get stuck; since coding comfort will vary widely with no prerequisite, plan to pair or group students so stronger coders can support those still building confidence
